 ...
 */
export declare function getGraphicsPolicy(): GraphicsPolicy;
/**
 ...
 */
export declare function configureR3GraphicsPolicy(partial: Partial<GraphicsPolicy>): void;
/**
 ...
 */
export declare function clampDevicePixelRatio(dpr: number): number;
/**
 ...
 */
export declare function resolveUiTexturePixelRatio(): number;
