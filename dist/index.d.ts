...
export type { NodeOptions, NodeListener, NodeEventName, PointerEvent, Pivot, Rect as NodeHitRect, } from './Node.ts';
export { Container } from './Container.ts';
export type { ContainerOptions } from './Container.ts';
export { R3LayoutRoot, R3MotionRoot, createR3CenteredMotionSurface, createR3LayoutRoot, createR3MotionRoot, createR3MotionSurface, playR3MotionPressPulse, playR3MotionRejectShake, resetR3MotionRoot, tweenR3MotionScale, } from './LayoutMotion.ts';
export type { R3CenteredMotionSurface, R3CenteredMotionSurfaceOptions, R3MotionSurface, R3MotionPressPulseOptions, R3MotionRejectShakeOptions, R3MotionScaleTweenOptions, } from './LayoutMotion.ts';
...
export type { TweenConfig, TweenHandle, TweenTarget, TweenProps, TweenPropConfig, } from './Tween.ts';
...
export { acquireRaster, releaseRaster, trimCachedTextures, rasterCacheStats, } from './TextureCache.ts';
...
export { wrapText, buildFontShorthand, snapshotMetrics, } from './text-metrics.ts';
export type { WrapOptions, WrappedLine, MeasureFn, FontStyleSpec, CanvasMetricSnapshot, } from './text-metrics.ts';
export { createR3Button } from './widgets/Button.ts';
export type { R3ButtonOptions, R3ButtonHandle, R3ButtonVariant, R3ButtonClickSfx, } from './widgets/Button.ts';
export { createR3OrnateButton } from './widgets/OrnateButton.ts';
export type { R3OrnateButtonOptions, R3OrnateButtonHandle, R3OrnateButtonVariant, R3OrnateButtonClickSfx, } from './widgets/OrnateButton.ts';
export { createR3Heading } from './widgets/Heading.ts';
export type { R3HeadingOptions, R3HeadingHandle, R3HeadingStroke, } from './widgets/Heading.ts';
export { openR3Dialog } from './widgets/Dialog.ts';
export type { R3DialogOptions, R3DialogHandle, R3DialogSize, R3DialogVisual, R3DialogTiming, R3DialogBuildContext, } from './widgets/Dialog.ts';
...
export type { ScrollAxis, AxisGestureIntent, ScrollModelConfig, } from './scroll/ScrollModel.ts';
...
export type { R3PanelOptions, R3HudPanelGeometry, R3ResizableHudPanelHandle, } from './widgets/Panel.ts';
...
export type { R3PlaqueHost, R3PlaqueShadow, R3PlaqueOptions, R3PlaqueHandle, R3PlaqueButtonOptions, R3PlaqueButtonHandle, } from './widgets/Plaque.ts';
export { attachCanvasPointerBridge } from './canvasPointerBridge.ts';
export type { CanvasPointerBridgeOptions, CanvasPointerBridgeHandle, } from './canvasPointerBridge.ts';
export { SPOTLIGHT_OVERLAY_DEPTH, createSpotlightArrowRenderer, computeSpotlightOverlayLayout, installSpotlightOverlay, } from './spotlight';
export type { SpotlightAdornmentRenderContext, SpotlightAdornmentRenderer, SpotlightAnchorSide, SpotlightOverlayHandle, SpotlightOverlayLayout, SpotlightOverlayOptions, SpotlightTarget, } from './spotlight';
export { installR3Inspector, uninstallR3Inspector, R3_INSPECTOR_VERSION, } from './inspect.ts';
export type { R3Inspector, InspectedNode, NodeQuery, InstallR3InspectorOptions, } from './inspect.ts';
export { COLOR, COLOR_HEX, FONT, configureR3Theme } from './theme';
export type { ColorToken, ColorValue, FontStack, R3ThemeOverrides, } from './theme';
export { configureR3GraphicsPolicy, getGraphicsPolicy, } from './graphics-policy';
export type { GraphicsPolicy, UiTexturePixelRatioMode, } from './graphics-policy';
export { configureR3ImageSlotProvider, createUrlImageSlotProvider, } from './image-loading';
