...
export {
  ...
  type SerialFlexNode,
  type SerialLeafNode,
  type SerialAbsoluteChild,
  type SerialAnchorPlacement,
  type LeafBindings,
} from "./serialize.ts";
...
export {
  LayoutKeyRegistry,
  type LayoutTargetRegistry,
  type LayoutTargetSnapshot,
} from "./registry.ts";

export {
  SceneResponsiveLayout,
  type SceneResponsiveLayoutOptions,
} from "./SceneResponsiveLayout.ts";
...
export {
  containedRectWithin,
  type ContainedRectAlignment,
  type ContainedRectOptions,
} from "./containedRect.ts";
...
export {
  ...
  nodeLocalRectWorldBounds,
  layoutTransformMatrix,
  type PositionAndSizeTarget,
} from "./r3-binding.ts";
...
export {
  ...
  type LayoutVanishingPointAxis,
  type LayoutVanishingPointPreset,
  type LayoutVanishingPointPresets,
  type LayoutVanishingPointProjection,
} from "./types.ts";

// Direct-manipulation editor toolkit — optional, consumable by any
// host that implements {@link LayoutEditorHost}.
export {
  LayoutEditor,
  installLayoutEditorOverlay,
  LAYOUT_EDITOR_OVERLAY_DEPTH,
  ALL_HANDLES as LAYOUT_EDITOR_HANDLES,
  HANDLE_SIZE as LAYOUT_EDITOR_HANDLE_SIZE,
  handleRect,
  pointToInsets,
  resizeRect,
  snapTo,
  ...
  type EditorState as LayoutEditorState,
  type EditorViewport as LayoutEditorViewport,
  type LayoutEditorHost,
  type LayoutEditorOptions,
  type LayoutEditorOverlayHandle,
  type LayoutEditorOverlayOptions,
  type ResizeHandle as LayoutResizeHandle,
  type SkipKeyPredicate as LayoutEditorSkipKey,
} from "./editor";
